...
- Tests coverage is still low as mentioned before, but coverage and tests are available. Added v0.1 of [Test Documentation](test_report.md) which only includes test coverage for now.
